...
REPO_DIR   = Path("/home/user/exer")
OUTPUT_DIR = Path("/home/user/organized_workouts")
KEEP_OUT   = Path("/home/user/keep_out_filenames.json")
...
def run():
    ...
    accounted = len(audit_rows) + len(content_filtered) + len(dup_filtered) + len(final)
